...
with st.sidebar:
    ...
    if tur_giris == "Gider":
        ...
        st.info("👇 Ne kadar aldığını yaz")
        miktar = st.text_input("Miktar (Örn: 5 Gram)")
        if miktar:
            miktar_bilgisi = f"[{miktar}] "
    ...
    if st.button("Kaydet 💾", type="primary"):
        if tutar_giris > 0:
            ...
            final_aciklama = miktar_bilgisi + aciklama_giris if aciklama_giris else miktar_bilgisi + "Yatırım"
...
if not df.empty:
    ...
    with tab1:
        ...
        with g1:
            ...
            # BURASI DEĞİŞTİ: Hem Gider Hem Yatırım grafikte yer alıyor
            ...
            if not df_pie.empty:
                ...
                # Grafik üzerine ₺ simgesi ve format ekleme
